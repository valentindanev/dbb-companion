...
#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FRAME_LEN_MAX  68

#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_ID_OR_MAC_NUM  20 // number of elements in array
#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_ID_OR_MAC_LEN  20 // length of array = number of bytes
#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_OPERATOR_ID_NUM  20 // number of elements in array
#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_OPERATOR_ID_LEN  20 // length of array = number of bytes

#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_TARGET_SYSTEM_OFS  0
#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_TARGET_COMPONENT_OFS  1
#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_ID_OR_MAC_OFS  2
#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_OPERATOR_ID_TYPE_OFS  22
#define FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_OPERATOR_ID_OFS  23


//----------------------------------------
//-- Message OPEN_DRONE_ID_OPERATOR_ID pack,encode routines, for sending
//----------------------------------------
...
{
    fmav_open_drone_id_operator_id_t* _payload = (fmav_open_drone_id_operator_id_t*)_msg->payload;
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_OPEN_DRONE_ID_OPERATOR_ID;
    _msg->target_sysid = target_system;
    _msg->target_compid = target_component;
    _msg->crc_extra = FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_CRCEXTRA;
    _msg->payload_max_len = FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_PAYLOAD_LEN_MAX;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_open_drone_id_operator_id_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_open_drone_id_operator_id_t* _payload = (fmav_open_drone_id_operator_id_t*)(&_buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_OPEN_DRONE_ID_OPERATOR_ID;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_OPEN_DRONE_ID_OPERATOR_ID >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_OPEN_DRONE_ID_OPERATOR_ID >> 16);
...
//----------------------------------------
//-- Message OPEN_DRONE_ID_OPERATOR_ID decode routines, for receiving
//----------------------------------------
...
FASTMAVLINK_FUNCTION_DECORATOR void fmav_msg_open_drone_id_operator_id_decode(fmav_open_drone_id_operator_id_t* payload, const fmav_message_t* msg)
{
    ...
    if (msg->len < FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_PAYLOAD_LEN_MAX) {
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_open_drone_id_operator_id_get_field_target_system(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_open_drone_id_operator_id_get_field_target_component(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_open_drone_id_operator_id_get_field_operator_id_type(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t* fmav_msg_open_drone_id_operator_id_get_field_id_or_mac_ptr(const fmav_message_t* msg)
{
    return (uint8_t*)&(msg->payload[2]);
}


FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_open_drone_id_operator_id_get_field_id_or_mac(uint16_t index, const fmav_message_t* msg)
{
    if (index >= FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_ID_OR_MAC_NUM) return 0;
    return ((uint8_t*)&(msg->payload[2]))[index];
}


FASTMAVLINK_FUNCTION_DECORATOR char* fmav_msg_open_drone_id_operator_id_get_field_operator_id_ptr(const fmav_message_t* msg)
{
    return (char*)&(msg->payload[23]);
}


FASTMAVLINK_FUNCTION_DECORATOR char fmav_msg_open_drone_id_operator_id_get_field_operator_id(uint16_t index, const fmav_message_t* msg)
{
    if (index >= FASTMAVLINK_MSG_OPEN_DRONE_ID_OPERATOR_ID_FIELD_OPERATOR_ID_NUM) return 0;
