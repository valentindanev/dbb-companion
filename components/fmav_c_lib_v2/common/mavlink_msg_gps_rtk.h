...
#pragma once
#ifndef FASTMAVLINK_MSG_GPS_RTK_H
#define FASTMAVLINK_MSG_GPS_RTK_H
...
FASTMAVLINK_PACK(
typedef struct _fmav_gps_rtk_t {
...
#define FASTMAVLINK_MSG_ID_GPS_RTK  127

#define FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MAX  35
#define FASTMAVLINK_MSG_GPS_RTK_CRCEXTRA  25

#define FASTMAVLINK_MSG_GPS_RTK_FLAGS  0
#define FASTMAVLINK_MSG_GPS_RTK_TARGET_SYSTEM_OFS  0
#define FASTMAVLINK_MSG_GPS_RTK_TARGET_COMPONENT_OFS  0

#define FASTMAVLINK_MSG_GPS_RTK_FRAME_LEN_MAX  60



#define FASTMAVLINK_MSG_GPS_RTK_FIELD_TIME_LAST_BASELINE_MS_OFS  0
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_TOW_OFS  4
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_BASELINE_A_MM_OFS  8
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_BASELINE_B_MM_OFS  12
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_BASELINE_C_MM_OFS  16
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_ACCURACY_OFS  20
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_IAR_NUM_HYPOTHESES_OFS  24
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_WN_OFS  28
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_RTK_RECEIVER_ID_OFS  30
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_RTK_HEALTH_OFS  31
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_RTK_RATE_OFS  32
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_NSATS_OFS  33
#define FASTMAVLINK_MSG_GPS_RTK_FIELD_BASELINE_COORDS_TYPE_OFS  34


//----------------------------------------
//-- Message GPS_RTK pack,encode routines, for sending
//----------------------------------------
    ...
    fmav_status_t* _status)
{
    ...
    _msg->payload_max_len = FASTMAVLINK_MSG_GPS_RTK_PAYLOAD_LEN_MAX;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_gps_rtk_pack_to_serial(
    uint8_t sysid,
    uint8_t compid,
    uint32_t time_last_baseline_ms, uint8_t rtk_receiver_id, uint16_t wn, uint32_t tow, uint8_t rtk_health, uint8_t rtk_rate, uint8_t nsats, uint8_t baseline_coords_type, int32_t baseline_a_mm, int32_t baseline_b_mm, int32_t baseline_c_mm, uint32_t accuracy, int32_t iar_num_hypotheses,
    fmav_status_t* _status)
{
    fmav_gps_rtk_t _payload;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_gps_rtk_encode_to_serial(
    uint8_t sysid,
    uint8_t compid,
    const fmav_gps_rtk_t* _payload,
    fmav_status_t* _status)
...
FASTMAVLINK_FUNCTION_DECORATOR uint32_t fmav_msg_gps_rtk_get_field_time_last_baseline_ms(const fmav_message_t* msg)
{
    uint32_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint32_t fmav_msg_gps_rtk_get_field_tow(const fmav_message_t* msg)
{
    uint32_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR int32_t fmav_msg_gps_rtk_get_field_baseline_a_mm(const fmav_message_t* msg)
{
    int32_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR int32_t fmav_msg_gps_rtk_get_field_baseline_b_mm(const fmav_message_t* msg)
{
    int32_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR int32_t fmav_msg_gps_rtk_get_field_baseline_c_mm(const fmav_message_t* msg)
{
    int32_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint32_t fmav_msg_gps_rtk_get_field_accuracy(const fmav_message_t* msg)
{
    uint32_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR int32_t fmav_msg_gps_rtk_get_field_iar_num_hypotheses(const fmav_message_t* msg)
{
    int32_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_gps_rtk_get_field_wn(const fmav_message_t* msg)
{
    uint16_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_gps_rtk_get_field_rtk_receiver_id(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_gps_rtk_get_field_rtk_health(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_gps_rtk_get_field_rtk_rate(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_gps_rtk_get_field_nsats(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_gps_rtk_get_field_baseline_coords_type(const fmav_message_t* msg)
{
    uint8_t r;
...
#define mavlink_gps_rtk_t  fmav_gps_rtk_t
...
FASTMAVLINK_FUNCTION_DECORATOR void mavlink_msg_gps_rtk_decode(const mavlink_message_t* msg, mavlink_gps_rtk_t* payload)
{
    fmav_msg_gps_rtk_decode(payload, msg);
}

#endif // FASTMAVLINK_PYMAVLINK_ENABLED


#endif // FASTMAVLINK_MSG_GPS_RTK_H
