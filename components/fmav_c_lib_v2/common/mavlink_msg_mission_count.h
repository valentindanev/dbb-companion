...
//----------------------------------------
//-- Message MISSION_COUNT pack,encode routines, for sending
//----------------------------------------
    ...
    fmav_status_t* _status)
{
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_MISSION_COUNT;
    _msg->target_sysid = target_system;
    _msg->target_compid = target_component;
    _msg->crc_extra = FASTMAVLINK_MSG_MISSION_COUNT_CRCEXTRA;
    _msg->payload_max_len = FASTMAVLINK_MSG_MISSION_COUNT_PAYLOAD_LEN_MAX;
    ...
    fmav_status_t* _status)
{
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_MISSION_COUNT;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_MISSION_COUNT >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_MISSION_COUNT >> 16);
