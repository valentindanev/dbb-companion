...
//----------------------------------------
//-- Message GIMBAL_MANAGER_SET_ATTITUDE pack,encode routines, for sending
//----------------------------------------
...
{
    fmav_gimbal_manager_set_attitude_t* _payload = (fmav_gimbal_manager_set_attitude_t*)_msg->payload;
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_GIMBAL_MANAGER_SET_ATTITUDE;
    _msg->target_sysid = target_system;
    _msg->target_compid = target_component;
    _msg->crc_extra = FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_ATTITUDE_CRCEXTRA;
    _msg->payload_max_len = FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_ATTITUDE_PAYLOAD_LEN_MAX;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_gimbal_manager_set_attitude_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_gimbal_manager_set_attitude_t* _payload = (fmav_gimbal_manager_set_attitude_t*)(&_buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_GIMBAL_MANAGER_SET_ATTITUDE;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_GIMBAL_MANAGER_SET_ATTITUDE >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_GIMBAL_MANAGER_SET_ATTITUDE >> 16);
...
//----------------------------------------
//-- Message GIMBAL_MANAGER_SET_ATTITUDE decode routines, for receiving
//----------------------------------------
