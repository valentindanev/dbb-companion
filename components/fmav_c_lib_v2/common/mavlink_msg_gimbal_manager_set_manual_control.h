...
#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FRAME_LEN_MAX  48



#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FIELD_FLAGS_OFS  0
#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FIELD_PITCH_OFS  4
#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FIELD_YAW_OFS  8
#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FIELD_PITCH_RATE_OFS  12
#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FIELD_YAW_RATE_OFS  16
#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FIELD_TARGET_SYSTEM_OFS  20
#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FIELD_TARGET_COMPONENT_OFS  21
#define FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_FIELD_GIMBAL_DEVICE_ID_OFS  22


//----------------------------------------
//-- Message GIMBAL_MANAGER_SET_MANUAL_CONTROL pack,encode routines, for sending
//----------------------------------------
...
{
    fmav_gimbal_manager_set_manual_control_t* _payload = (fmav_gimbal_manager_set_manual_control_t*)_msg->payload;
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_GIMBAL_MANAGER_SET_MANUAL_CONTROL;
    _msg->target_sysid = target_system;
    _msg->target_compid = target_component;
    _msg->crc_extra = FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_CRCEXTRA;
    _msg->payload_max_len = FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_PAYLOAD_LEN_MAX;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_gimbal_manager_set_manual_control_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_gimbal_manager_set_manual_control_t* _payload = (fmav_gimbal_manager_set_manual_control_t*)(&_buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_GIMBAL_MANAGER_SET_MANUAL_CONTROL;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_GIMBAL_MANAGER_SET_MANUAL_CONTROL >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_GIMBAL_MANAGER_SET_MANUAL_CONTROL >> 16);
...
//----------------------------------------
//-- Message GIMBAL_MANAGER_SET_MANUAL_CONTROL decode routines, for receiving
//----------------------------------------
...
FASTMAVLINK_FUNCTION_DECORATOR void fmav_msg_gimbal_manager_set_manual_control_decode(fmav_gimbal_manager_set_manual_control_t* payload, const fmav_message_t* msg)
{
    ...
    if (msg->len < FASTMAVLINK_MSG_GIMBAL_MANAGER_SET_MANUAL_CONTROL_PAYLOAD_LEN_MAX) {
...
FASTMAVLINK_FUNCTION_DECORATOR uint32_t fmav_msg_gimbal_manager_set_manual_control_get_field_flags(const fmav_message_t* msg)
{
    uint32_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR float fmav_msg_gimbal_manager_set_manual_control_get_field_pitch(const fmav_message_t* msg)
{
    float r;
...
FASTMAVLINK_FUNCTION_DECORATOR float fmav_msg_gimbal_manager_set_manual_control_get_field_yaw(const fmav_message_t* msg)
{
    float r;
...
FASTMAVLINK_FUNCTION_DECORATOR float fmav_msg_gimbal_manager_set_manual_control_get_field_pitch_rate(const fmav_message_t* msg)
{
    float r;
...
FASTMAVLINK_FUNCTION_DECORATOR float fmav_msg_gimbal_manager_set_manual_control_get_field_yaw_rate(const fmav_message_t* msg)
{
    float r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_gimbal_manager_set_manual_control_get_field_target_system(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_gimbal_manager_set_manual_control_get_field_target_component(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_gimbal_manager_set_manual_control_get_field_gimbal_device_id(const fmav_message_t* msg)
{
    uint8_t r;
