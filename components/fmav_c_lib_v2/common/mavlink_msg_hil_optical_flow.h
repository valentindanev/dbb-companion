...
//----------------------------------------
//-- Message HIL_OPTICAL_FLOW pack,encode routines, for sending
//----------------------------------------
...
{
    fmav_hil_optical_flow_t* _payload = (fmav_hil_optical_flow_t*)_msg->payload;
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_HIL_OPTICAL_FLOW;
    _msg->target_sysid = 0;
    _msg->target_compid = 0;
    _msg->crc_extra = FASTMAVLINK_MSG_HIL_OPTICAL_FLOW_CRCEXTRA;
    _msg->payload_max_len = FASTMAVLINK_MSG_HIL_OPTICAL_FLOW_PAYLOAD_LEN_MAX;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_hil_optical_flow_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_hil_optical_flow_t* _payload = (fmav_hil_optical_flow_t*)(&_buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_HIL_OPTICAL_FLOW;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_HIL_OPTICAL_FLOW >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_HIL_OPTICAL_FLOW >> 16);
