...
#define FASTMAVLINK_MSG_EXTENDED_SYS_STATE_FRAME_LEN_MAX  27



#define FASTMAVLINK_MSG_EXTENDED_SYS_STATE_FIELD_VTOL_STATE_OFS  0
#define FASTMAVLINK_MSG_EXTENDED_SYS_STATE_FIELD_LANDED_STATE_OFS  1
...
{
    fmav_extended_sys_state_t* _payload = (fmav_extended_sys_state_t*)_msg->payload;
    ...
    _msg->sysid = sysid;
    _msg->compid = compid;
    _msg->msgid = FASTMAVLINK_MSG_ID_EXTENDED_SYS_STATE;
    _msg->target_sysid = 0;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_extended_sys_state_pack_to_frame_buf(
    ...
    fmav_status_t* _status)
{
    fmav_extended_sys_state_t* _payload = (fmav_extended_sys_state_t*)(&_buf[FASTMAVLINK_HEADER_V2_LEN]);
    ...
    _buf[5] = sysid;
    _buf[6] = compid;
    _buf[7] = (uint8_t)FASTMAVLINK_MSG_ID_EXTENDED_SYS_STATE;
    _buf[8] = ((uint32_t)FASTMAVLINK_MSG_ID_EXTENDED_SYS_STATE >> 8);
    _buf[9] = ((uint32_t)FASTMAVLINK_MSG_ID_EXTENDED_SYS_STATE >> 16);
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_extended_sys_state_pack_to_serial(
    uint8_t sysid,
    uint8_t compid,
    uint8_t vtol_state, uint8_t landed_state,
    fmav_status_t* _status)
{
    fmav_extended_sys_state_t _payload;
    ...
    return fmav_finalize_serial(
        ...
        compid,
        (uint8_t*)&_payload,
        FASTMAVLINK_MSG_ID_EXTENDED_SYS_STATE,
        FASTMAVLINK_MSG_EXTENDED_SYS_STATE_PAYLOAD_LEN_MAX,
        FASTMAVLINK_MSG_EXTENDED_SYS_STATE_CRCEXTRA,
        _status);
}
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t fmav_msg_extended_sys_state_encode_to_serial(
    uint8_t sysid,
    uint8_t compid,
    const fmav_extended_sys_state_t* _payload,
    fmav_status_t* _status)
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_extended_sys_state_get_field_vtol_state(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint8_t fmav_msg_extended_sys_state_get_field_landed_state(const fmav_message_t* msg)
{
    uint8_t r;
...
FASTMAVLINK_FUNCTION_DECORATOR uint16_t mavlink_msg_extended_sys_state_encode(
    uint8_t sysid,
    uint8_t compid,
    mavlink_message_t* _msg,
    const mavlink_extended_sys_state_t* _payload)
{
    return mavlink_msg_extended_sys_state_pack(
        sysid,
        compid,
        _msg,
        _payload->vtol_state, _payload->landed_state);
