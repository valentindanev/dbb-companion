...
db_parameter_t db_param_proto = {
    ...
    .value = {.db_param_u8 = {
                  ...
                  // DBB: ArduPilot is MAVLink-only — clamp so MSP/LTM/Transparent can't be selected
                  .min = DB_SERIAL_PROTOCOL_MAVLINK,
                  .max = DB_SERIAL_PROTOCOL_MAVLINK,
              }}};
...
void db_param_init_parameters() {
  ...
  db_param_wifi_ap_ip = db_param_init_str_param(
      "ap_ip", "WIFI_AP_IP", "192.168.42.1", 8, IP4ADDR_STRLEN_MAX);
